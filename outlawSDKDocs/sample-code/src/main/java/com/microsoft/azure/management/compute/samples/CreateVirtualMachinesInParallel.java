...
public final class CreateVirtualMachinesInParallel {
    ...
    public static boolean runSample(Azure azure) {
        ...
        // final demo target
        virtualMachinesByLocation.put(Region.US_EAST, 1);
        virtualMachinesByLocation.put(Region.US_SOUTH_CENTRAL, 1);
        virtualMachinesByLocation.put(Region.US_WEST, 1);
        virtualMachinesByLocation.put(Region.US_NORTH_CENTRAL, 1);
